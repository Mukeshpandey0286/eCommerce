...
urlpatterns = [
    ...
    path('product-detail/<int:pk>', views.ProductDetailVeiw.as_view(), name='product-detail'),
    ...
    path('topwear/<slug:data>', views.top, name='topdata'),
    path('bottomwear/', views.bot, name='bot'),
    path('bottomwear/<slug:data>', views.bot, name='botdata'),
